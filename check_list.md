...
- [x] Backup Strategy (manual to USB and local)
- [x] Doxygen Setup
...
### System Robustness & Safety
- [ ] Stack Overflow Detection (canary values or boundary check per task)
...
### Reliability Testing & Stress Tools
...
- [ ] Remote Firmware Update via CLI (UART/USB hex file loader)
