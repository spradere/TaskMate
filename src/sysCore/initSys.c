...
void initDrivers(void)
{
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver0_name,
									  .status = 1,
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver1_name,
									  .status = 1,
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver2_name,
									  .status = 1,
									  .init = hal_i2cInit,
									  .start = hal_i2cStart,
									  .stop = hal_i2cStop};
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver3_name,
									  .status = 1,
									  .init = hal_usartInit,
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver4_name,
									  .status = 2,
									  .init = hal_lcdInit,
									  .start = hal_lcdStart,
									  .stop = hal_lcdStop};
	...
	*(mod_d) = (module_item_driver_t){.name = (uint8_t *)driver5_name,
									  .status = 2,
									  .init = hal_ZS_042Init,
