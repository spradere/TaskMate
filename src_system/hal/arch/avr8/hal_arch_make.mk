...
VAL_HW_STACK += avr8
PATH_AVR8 = ${PATH_SRCS_SYSTEM}/hal/arch/avr8
...
CFLAGS_${PATH_SRCS_SYSTEM}/hal/arch/avr8/hal_context_impl.c = \
	-DTM_SYSTEM_CRITICAL_ALLOWED
	
# Compilation redirection
FILE_ARCH_CC = ${PATH_SRCS_SYSTEM}/hal/arch/avr8/hal_archCC.mk
...
CFLAGS += -I${PATH_SRCS_SYSTEM} -I./ -I${PATH_SRCS_USER} 
